 ...
 */
public class UsherSQLSelectItem extends SQLSelectItem {
     ...
     * 对应方法名称
     */
    private SqlMethodEnum methodEnum;

    public UsherSQLSelectItem(SQLExpr expr, String alias, SQLSelectItem selectItem) {
        super(expr, alias);
        this.selectItem = selectItem;
    }

    public UsherSQLSelectItem(SQLExpr expr, String alias, SQLSelectItem selectItem, SqlMethodEnum methodEnum) {
