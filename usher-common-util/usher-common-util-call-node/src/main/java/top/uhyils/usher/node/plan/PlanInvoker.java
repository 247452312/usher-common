...
import top.uhyils.usher.node.util.PlanUtil;
...
public class PlanInvoker {
     ...
     */
    public static NodeInvokeResult execute(String sql, Map<String, String> headers, MysqlServiceHandler handler) {
     ...
     * @return 每个执行计划的结果 key->执行计划id value->执行计划执行结果
     */
    public static NodeInvokeResult execute(String sql, MysqlServiceHandler handler) {
     ...
     * @return 每个执行计划的结果
     */
    public static NodeInvokeResult execute(String sql, Map<String, String> headers, JSONObject params, MysqlServiceHandler handler) {
