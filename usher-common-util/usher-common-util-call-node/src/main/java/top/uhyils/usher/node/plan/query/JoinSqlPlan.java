package top.uhyils.usher.node.plan.query;
...
public abstract class JoinSqlPlan extends AbstractMysqlSqlPlan {
     ...
     * @return
     */
    protected boolean checkMerge(JSONObject leftResult, JSONObject rightResult, List<List<SQLBinaryOpExpr>> on, String leftAlias, String rightAlias) {
        // 外层是or 只要有一个true即可返回
